...
project_root = db_path_path.parents[1] # goes to folder new_DB_tests
print(project_root)

api_key_path = project_root / "Streamlit info" / "NextSDS API key.txt"
folder_excels = project_root / "CPS"
save_json_dirr = project_root / "JSON"
folder = folder_excels
image_dir = project_root / "Chem_image"
template_path = project_root / "Template" / "CPS_CAS TEMPLATE V2.xlsm"
folder_for_saving = project_root / "Downloads from Streamlit"
print(api_key_path)

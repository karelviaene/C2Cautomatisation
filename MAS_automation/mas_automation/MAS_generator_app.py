...
class App:
    def __init__(self, root: tk.Tk) -> None:
        ...
        self.command = [sys.executable, "MAS_generation.py"]
    ...
    def _build_ui(self) -> None:
        ...
        title = ttk.Label(
            top,
            text="Merge instead of Powerquery",
        ...
        input_label = ttk.Label(bottom, text="Send input to program (write the tier number):")
